...
//_Createnoticesms
$('#Createnoticesmstypeform').submit(function (event) {
    ...
    setTimeout(function () {
        ...
        if (validationmelength == 0 && validationMessages2.length == 0) {
            ...
            var noticeFormData = new FormData($('#Createnoticesmstypeform')[0]);
            ...
            switch (Clickbuttonid) {
                case 'btnSubmit':
                    FileCallToAjax('POST', '/Admin/_Createnoticesms', noticeFormData,
                        function (response) {
                            debugger;
